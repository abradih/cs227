...
public class TaxiTest {
	...
	public static void main(String[] args) {
		// constructs a new taxi with a base fare of $2.00
		...
		// after startRide, the meter should be 2.00 and the current rate should
		// be 3.00
		t.startRide(); // a passenger gets in
		System.out.println(t.getMeter());
		...
		// after endRide, meter and current rate should be 0
		t.endRide();
		System.out.println(t.getMeter());
		System.out.println("Expected 0");
		System.out.println(t.getCurrentRate());
